...
- (void)viewDidLoad {
    ...
    _funcArray = [[NSMutableArray alloc]initWithObjects:@"Device info",@"Battery Info", @"Sync time", @"Download file",@"Factory Reset",@"Scale Run Prams", @"Scale Real-time Data",nil];
